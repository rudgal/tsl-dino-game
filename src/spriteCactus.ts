/**
 * Cactus sprite utilities for TSL shader system
 */
...
export const spriteCactusSmall = Fn(([spriteTexture, p, scale, variant]: FnArguments) => {
...
export const spriteCactusLarge = Fn(([spriteTexture, p, scale, variant]: FnArguments) => {
  // Select sprite coordinates based on variant
  const coords = {
